namespace MyCompany.MyExamples.WorkerServiceExampleOne.DomainDataLayer.EntityFramework
{
    using System;
    ...
    public class MyParentEntityFrameworkDomainDataLayer : IMyParentDomainData
    {
        ...
        private readonly WorkerServiceExampleOneDbContext entityDbContext;

        public MyParentEntityFrameworkDomainDataLayer(ILoggerFactory loggerFactory, WorkerServiceExampleOneDbContext context)
        {
        ...
        public async Task<IEnumerable<MyParentEntity>> PerformDemoIQueryableWithAnonymousClass(TimeSpan cutOffTimeSpan, ICollection<int> magicStatusValues, CancellationToken token)
        {
             ...
             * Search for "will be evaluated locally" in the "MyCompany.MyExamples.WorkerServiceExampleOne.ConsoleOne.log*.txt" file.  (Where * is the date stamp)
             * */
